 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_SUP_CONGESTION = 18;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_SUP_CALL_WAITING = 22;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_SUP_RINGTONE = 23;
/**
 * Proprietary tone, general beep: 400Hz+1200Hz, 35ms ON
 *
 * @see #ToneGenerator(int, int)
 */
export const TONE_PROP_BEEP = 24;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_CALL_SIGNAL_ISDN_NORMAL = 45;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_CALL_SIGNAL_ISDN_INTERGROUP = 46;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_CALL_SIGNAL_ISDN_SP_PRI = 47;
/**
 * ISDN Call sign PAT3 tone: silent tone
 *
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_CALL_SIGNAL_ISDN_PAT3 = 48;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_CALL_SIGNAL_ISDN_PING_RING = 49;
/**
 *
 * ISDN Pat5 tone: silent tone
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_CALL_SIGNAL_ISDN_PAT5 = 50;
/**
 *
 * ISDN Pat6 tone: silent tone
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_CALL_SIGNAL_ISDN_PAT6 = 51;
/**
 * ISDN Pat7 tone: silent tone
 *
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_CALL_SIGNAL_ISDN_PAT7 = 52;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_L = 53;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_L = 54;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_L = 55;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_SS = 56;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_SS = 57;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_SS = 58;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_SSL = 59;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_SSL = 60;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_SSL = 61;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_SS_2 = 62;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_SS_2 = 63;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_SS_2 = 64;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_SLS = 65;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_SLS = 66;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_SLS = 67;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_S_X4 = 68;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_S_X4 = 69;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_S_X4 = 70;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_PBX_L = 71;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_PBX_L = 72;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_PBX_L = 73;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_PBX_SS = 74;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_PBX_SS = 75;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_PBX_SS = 76;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_PBX_SSL = 77;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_PBX_SSL = 78;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_PBX_SSL = 79;
/**
 * CDMA HIGH PBX SSL tone:{3700Hz 25ms, 4000Hz 25ms} 8 times
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_PBX_SLS = 80;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_PBX_SLS = 81;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_PBX_SLS = 82;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_HIGH_PBX_S_X4 = 83;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_MED_PBX_S_X4 = 84;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_LOW_PBX_S_X4 = 85;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_ALERT_NETWORK_LITE = 86;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_ALERT_AUTOREDIAL_LITE = 87;
/**
 * CDMA One Min Beep tone: 1150Hz+770Hz 400ms ON
 *
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_ONE_MIN_BEEP = 88;
/**
 *
 * CDMA KEYPAD Volume key lite tone: 941Hz+1477Hz 120ms ON
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_KEYPAD_VOLUME_KEY_LITE = 89;
/**
 * CDMA PRESSHOLDKEY LITE tone: 587Hz 375ms ON, 1175Hz 125ms ON
 *
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_PRESSHOLDKEY_LITE = 90;
/**
 ...
 * @see #ToneGenerator(int, int)
 */
export const TONE_CDMA_ALERT_INCALL_LITE = 91;
/**
